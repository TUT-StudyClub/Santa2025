...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 2025-12-29 | haruto | exp/kotou/20251229 | exp002_baseline Change SA movement range from fixed to dynamic | 42 | - | core=71.360590748689 | `uv run ./experiments/exp002_baseline/run.py exp=002` | - |
